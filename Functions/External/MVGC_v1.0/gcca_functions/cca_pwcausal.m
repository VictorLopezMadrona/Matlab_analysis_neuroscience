function [GW,COH,pp,waut,cons,S,A,Z]=cca_pwcausal(X,Nr,Nl,nlags,Fs,freq, STATFLAG)
% -----------------------------------------------------------------------
...
[pp,cohe,Fx2y,Fy2x,S,A,Z]=pwcausal(X,Nr,Nl,nlags,Fs,freq); %this function available from www.brain-smart.org
